...
7. [Option 1.a - Deploy to SAP BTP Cloud Foundry Runtime with SAP S/4HANA Cloud](./deploy/cf/deploy-to-cf.md)
7. [Option 1.b - Deploy to SAP BTP Kyma Runtime with SAP S/4HANA Cloud](./deploy/cf/deploy-to-cf.md)
8. [Option 2.a - Deploy to SAP BTP Cloud Foundry Runtime with Mock Server](./deploy/kyma/deploy-to-kyma.md)
8. [Option 2.b - Deploy to SAP BTP Kyma Runtime with Mock Server](./deploy/kyma/deploy-to-kyma.md)
